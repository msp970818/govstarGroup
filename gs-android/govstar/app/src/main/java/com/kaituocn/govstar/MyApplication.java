...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        TeamAVChatProfile.setContext(this);
...
//        config.notificationSound = "android.resource://com.netease.nim.demo/raw/msg";
    ...
    private LoginInfo loginInfo() {
        if (TextUtils.isEmpty(TeamAVChatProfile.getUserId())) {
            return null;
        }
        if (TextUtils.isEmpty(TeamAVChatProfile.getToken())) {
            return null;
        }
        return new LoginInfo(TeamAVChatProfile.getUserId(),TeamAVChatProfile.getToken());
    }
