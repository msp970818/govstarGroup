...
public class CalendarReminderUtils {
     ...
     * 添加日历事件
     */
    public static void addCalendarEvent(Context context, String title, String description, long startTime,long endTiem, int previousDate) {
        if (context == null) {
            return;
        }
        ...
        mCalendar.setTimeInMillis(endTiem);//设置终止时间，
