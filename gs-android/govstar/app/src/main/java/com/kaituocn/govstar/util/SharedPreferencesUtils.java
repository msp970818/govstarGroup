...
public class SharedPreferencesUtils {
    ...
    public static final String KEY_GESTURE_CODE= "gesture_code";
    public static final String KEY_YUN_TOKEN= "yun_token";
    public static final String KEY_USER= "user";
    public static final String KEY_BACKGROUD_URI= "background_uri";
